...
_M.default_config = {
    ...
    jaeger_service_name = env_value_ref('JAEGER_SERVICE_NAME'),
    jaeger_sampler_type = env_value_ref('JAEGER_SAMPLER_TYPE'),
    jaeger_sampler_param = env_value_ref('JAEGER_SAMPLER_PARAM'),
